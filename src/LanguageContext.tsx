...
export const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    "settings.theme": "وضع العرض (الثيم)",
    "settings.theme_desc": "التبديل بين الوضع الليلي المريح للعين والوضع النهاري عالي التباين",
    "settings.dark": "الوضع الليلي 🌙",
    "settings.light": "الوضع النهاري ☀️",
    "settings.language": "لغة التطبيق",
    "settings.language_desc": "اختر لغة الواجهة المفضلة لك (عربي / English)",
    "settings.password": "تعديل كلمة السر",
    "settings.password_desc": "قم بتحديث كلمة المرور الخاصة بحسابك لتعزيز الأمان",
    ...
    "settings.save_password": "تحديث كلمة السر 🔒",
    "settings.password_success": "تم تغيير كلمة المرور بنجاح!",
    "settings.password_error": "كلمة المرور الحالية غير صحيحة أو كلمتا المرور غير متطابقتين",
    "settings.personal_info": "تعديل البيانات الشخصية والتواصل",
    "settings.personal_info_desc": "تحديث الاسم ورقم الهاتف والعنوان لضمان دقة التقارير والتوصيل",
    "settings.fullname": "الاسم الكامل",
    "settings.phone": "رقم الهاتف الأساسي",
    "settings.phone_backup": "رقم الهاتف الاحتياطي",
    "settings.email": "البريد الإلكتروني",
    "settings.address": "العنوان بالتفصيل",
    "settings.governorate": "المحافظة",
    "settings.city": "المدينة",
    "settings.district": "الحي / المنطقة",
    "settings.save_personal": "حفظ البيانات الشخصية ✓",
    "settings.personal_success": "تم تحديث البيانات الشخصية بنجاح!",
    "settings.pharmacist_title": "إعدادات مكتب الصيدلي والملف المهني",
    "settings.pharmacist_specialties": "التخصصات السريرية المعتمدة (حتى 4 تخصصات)",
    "settings.pharmacist_specialties_desc": "حدد التخصصات الإكلينيكية التي تقدم فيها الاستشارات (الحد الأقصى: 4)",
    "settings.pharmacist_specialties_count": "التخصصات المختارة:",
    "settings.pharmacist_specialties_limit_warn": "تم الوصول للحد الأقصى (4 تخصصات)",
    "settings.admin_title": "لوحة إعدادات النظام والحوكمة",
    "settings.admin_regions": "إعدادات المحافظات والمناطق الجغرافية",
    "settings.admin_regions_desc": "إدارة وتفعيل نطاق التغطية الصيدلانية بالمحافظات المصرية",
    "settings.admin_specialties": "إعدادات تقسيم التخصصات الصيدلانية",
    "settings.admin_specialties_desc": "إدارة وتفعيل التخصصات الإكلينيكية المعتمدة في النظام",
    "settings.admin_max_specialties": "الحد الأقصى لتخصصات الصيدلي",
    "settings.admin_max_specialties_desc": "تحديد أقصى عدد من التخصصات يمكن للصيدلي الواحد اختيارها (مضبوط على 4)",
    "settings.admin_passcode": "تعديل رمز أمان الأدمن (Admin Passcode)",
    "settings.admin_passcode_save": "تحديث رمز الأمان",
    "settings.admin_passcode_success": "تم تحديث رمز أمان الأدمن بنجاح!",
  ...
  en: {
    ...
    "settings.theme_desc": "Switch between eye-comfortable dark mode and high-contrast light mode",
    "settings.dark": "Dark Mode 🌙",
    "settings.light": "Light Mode ☀️",
    "settings.language": "App Language",
    "settings.language_desc": "Choose your preferred interface language (Arabic / English)",
    "settings.password": "Change Password",
    "settings.password_desc": "Update your account password to enhance security",
    ...
    "settings.password_error": "Current password incorrect or passwords do not match",
    "settings.personal_info": "Edit Personal Profile & Contact Info",
    "settings.personal_info_desc": "Update name, phone numbers, and address for accurate reports and delivery",
    "settings.fullname": "Full Name",
    "settings.phone": "Primary Phone",
    "settings.phone_backup": "Backup Phone",
    "settings.email": "Email Address",
    "settings.address": "Detailed Address",
    "settings.governorate": "Governorate",
    "settings.city": "City",
    "settings.district": "District / Area",
    "settings.save_personal": "Save Profile Information ✓",
    "settings.personal_success": "Personal profile updated successfully!",
    "settings.pharmacist_title": "Pharmacist Workspace & Profile Settings",
    "settings.pharmacist_specialties": "Approved Clinical Specialties (Up to 4)",
    "settings.pharmacist_specialties_desc": "Select the clinical domains in which you offer consultations (Max 4)",
    "settings.pharmacist_specialties_count": "Selected Specialties:",
    "settings.pharmacist_specialties_limit_warn": "Maximum limit reached (4 specialties)",
    "settings.admin_title": "System Governance & Settings Panel",
    "settings.admin_regions": "Governorates & Geographic Regions Settings",
    "settings.admin_regions_desc": "Manage and activate coverage areas across Egyptian governorates",
    "settings.admin_specialties": "Clinical Specialties Division Settings",
    "settings.admin_specialties_desc": "Manage and toggle certified clinical specialties in the system",
    "settings.admin_max_specialties": "Max Pharmacist Specialties Limit",
    "settings.admin_max_specialties_desc": "Configure maximum allowed specialties per pharmacist (Configured to 4)",
    "settings.admin_passcode": "Change Admin Passcode",
    "settings.admin_passcode_save": "Update Security Passcode",
    "settings.admin_passcode_success": "Admin security passcode updated successfully!",
